...
#define DF_FN_LAYER 2
#define DV_FN_LAYER 3
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        [DEFAULT_LAYER] = LAYOUT_ANSI(
                ...
                KC_LCTL,  KC_LGUI,  KC_LALT,                      KC_SPC,                                 MO(DF_FN_LAYER), KC_LEFT,  KC_DOWN,            KC_RIGHT),
        [DVORAK_LAYER] = LAYOUT_ANSI(
                ...
                KC_LCTL,  KC_LGUI,  KC_LALT,                      KC_SPC,                                 MO(DV_FN_LAYER), KC_LEFT,  KC_DOWN,            KC_RIGHT),
        [DF_FN_LAYER] = LAYOUT_ANSI(
